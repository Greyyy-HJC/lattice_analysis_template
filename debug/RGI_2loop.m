...
gammac2[nf_] :=
    1 / (16 \[Pi]^2) * (CF * CA * (-(1108/27) - (11 \[Pi]^2) / 3 + 44 Zeta[3]
        ) + CF^2 * (-48 * Zeta[3] + (28 \[Pi]^2) / 3 - 8) + CF * nf * (2/27 * (80
         + 9 \[Pi]^2))); (* changed as Yu-Shan suggested *)
...
int1[\[Zeta]_] :=
    NIntegrate[1 / mu * (cusp1 * Log[\[Zeta] / mu^2] * asRun[mu, \[CapitalLambda], nf] + gammac1
         * asRun[mu, \[CapitalLambda], nf] + cusp2[nf] * Log[\[Zeta] / mu^2] * (asRun[mu, \[CapitalLambda], nf] ^
         2) + gammac2[nf] * (asRun[mu, \[CapitalLambda], nf] ^ 2)) /. {nf -> 3, \[CapitalLambda] -> \[CapitalLambda]3}, {mu,
        ...
        mu, \[CapitalLambda], nf] ^ 2) + gammac2[nf] * (asRun[mu, \[CapitalLambda], nf] ^ 2)) /. {nf -> 4, 
        \[CapitalLambda] -> \[CapitalLambda]4}, {mu, mc, 2}]
...
int2[\[Zeta]_] :=
    NIntegrate[1 / mu * (cusp1 * Log[\[Zeta] / mu^2] * asRun[mu, \[CapitalLambda], nf] + gammac1
         * asRun[mu, \[CapitalLambda], nf] + cusp2[nf] * Log[\[Zeta] / mu^2] * (asRun[mu, \[CapitalLambda], nf] ^
         2) + gammac2[nf] * (asRun[mu, \[CapitalLambda], nf] ^ 2)) /. {nf -> 4, \[CapitalLambda] -> \[CapitalLambda]4}, {mu,
         \[Sqrt]\[Zeta], 2}]
...
int3[\[Zeta]_] :=
    NIntegrate[1 / mu * (cusp1 * Log[\[Zeta] / mu^2] * asRun[mu, \[CapitalLambda], nf] + gammac1
         * asRun[mu, \[CapitalLambda], nf] + cusp2[nf] * Log[\[Zeta] / mu^2] * (asRun[mu, \[CapitalLambda], nf] ^
         2) + gammac2[nf] * (asRun[mu, \[CapitalLambda], nf] ^ 2)) /. {nf -> 5, \[CapitalLambda] -> \[CapitalLambda]5}, {mu,
         \[Sqrt]\[Zeta], mb}] + NIntegrate[1 / mu * (cusp1 * Log[\[Zeta] / mu^2] * asRun[mu, \[CapitalLambda],
         nf] + gammac1 * asRun[mu, \[CapitalLambda], nf] + cusp2[nf] * Log[\[Zeta] / mu^2] * (asRun[
        mu, \[CapitalLambda], nf] ^ 2) + gammac2[nf] * (asRun[mu, \[CapitalLambda], nf] ^ 2)) /. {nf -> 4, 
        \[CapitalLambda] -> \[CapitalLambda]4}, {mu, mb, 2}]

h01[\[Zeta]_] :=
    (asRun[Sqrt[\[Zeta]], \[CapitalLambda], nf] * CF / (2 \[Pi]) * (-2 + (\[Pi]^2) / 12) + asRun[Sqrt[
        \[Zeta]], \[CapitalLambda], nf] ^ 2 * C2[nf]) /. {nf -> 3, \[CapitalLambda] -> \[CapitalLambda]3}

h02[\[Zeta]_] :=
    (asRun[Sqrt[\[Zeta]], \[CapitalLambda], nf] * CF / (2 \[Pi]) * (-2 + (\[Pi]^2) / 12) + asRun[Sqrt[
        \[Zeta]], \[CapitalLambda], nf] ^ 2 * C2[nf]) /. {nf -> 4, \[CapitalLambda] -> \[CapitalLambda]4}

h03[\[Zeta]_] :=
    (asRun[Sqrt[\[Zeta]], \[CapitalLambda], nf] * CF / (2 \[Pi]) * (-2 + (\[Pi]^2) / 12) + asRun[Sqrt[
        \[Zeta]], \[CapitalLambda], nf] ^ 2 * C2[nf]) /. {nf -> 5, \[CapitalLambda] -> \[CapitalLambda]5}
